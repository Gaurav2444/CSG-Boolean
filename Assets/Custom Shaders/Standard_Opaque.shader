...
Shader "Custom/Standard"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float cos6_g61 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _MetallicMapRotation ) ) ) );
			float sin6_g61 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _MetallicMapRotation ) ) ) );
