...
Shader "Custom/Standard (CullOff)"
{
	Properties
	{
		...
		_MetallicMapRotation("MetallicMapRotation", Range( 0 , 360)) = 0
		...
		[Toggle]_InvertSmoothnessMap("RoughnessMap", Float) = 1
		[Header(NORMAL)][Normal]_BumpMap("NormalMap", 2D) = "bump" {}
		_BumpMapRotation("NormalMapRotation", Range( 0 , 360)) = 0
	...
	SubShader
	{
		...
		uniform float _MetallicMapRotation;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float cos6_g63 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _MetallicMapRotation ) ) ) );
			float sin6_g63 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _MetallicMapRotation ) ) ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-1448.6,673.501;Inherit;False;Property;_NormalMapRotation;NormalMapRotation;13;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;260;-1459.391,3014.062;Inherit;False;Property;_MetallicMapRotation;MetallicMapRotation;21;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
