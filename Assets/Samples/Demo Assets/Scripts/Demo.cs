...
namespace Parabox.CSG.Demo
{
	...
	public class Demo : MonoBehaviour
	{
		...
		void Awake()
		{
			...
			lastPosition = right.transform.position;
		...
		[Button]
		public void MakeOutlineMesh()
		{
			Debug.Log(right.GetComponent<MeshRenderer>().bounds);
		}

		void OnPositionChangedForRight()
		{
			currentPosition = right.transform.position;
        ...
        void Update()
		{
			...
			{
				right.transform.Translate(new Vector3(0, 1,0));
			}
            ...
            {
                right.transform.Translate(new Vector3(0, 0, 1));
            }
